...
const techniqueDisplayName = (proposal, after) => proposal.techniqueExperiment?.name || after.techniqueLabel || after.techniqueName || proposal.techniqueLabel || proposal.techniqueName || null;
