...
export const MODEL_PRICING = Object.freeze({
  ...
  'gpt-5.4': Object.freeze({ input: 2.50, output: 15, cacheRead: 0, cacheWrite: 0, source: 'https://developers.openai.com/api/docs/models' }),
  'gpt-5.4-mini': Object.freeze({ input: 0.75, output: 4.50, cacheRead: 0, cacheWrite: 0, source: 'https://developers.openai.com/api/docs/models' }),
