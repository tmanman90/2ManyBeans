...
const RECIPE_PROPERTIES = Object.freeze({ method: { type: 'string' }, device: { type: 'string' }, mode: { type: 'string' }, variant: { type: 'string' }, v60Variant: { type: 'string' }, v60Size: { type: 'string' }, kalitaSize: { type: 'string' }, configurationKey: { type: 'string' }, coffeeGrams: { type: 'number' }, userCoffeeGrams: { type: 'number' }, dose: { type: 'number' }, waterGrams: { type: 'number' }, water: { type: 'number' }, ratio: { type: ['number', 'string'] }, isIced: { type: 'boolean' }, hotWaterGrams: { type: 'number' }, recipeIceGrams: { type: 'number' }, temperatureC: { type: 'number' }, grind: { type: 'string' }, technique: { type: 'string' }, steps: { type: 'array' }, prepSteps: { type: 'array' }, postBrewSteps: { type: 'array' }, waterTemp: { type: 'object' }, grindSize: { type: 'object' }, sourceLineage: { type: 'object' }, totalBrewTimeSeconds: { type: 'number' }, guideTargetSeconds: { type: 'number' }, guideRangeSeconds: { type: 'array' }, timerReady: { type: 'boolean' }, reasonCodes: { type: 'array' }, reasoning: { type: 'string' } });
