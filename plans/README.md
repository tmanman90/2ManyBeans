...
| 002 | [Scan-save arrival (haptic + cascade)](002-scan-save-arrival.md) | MEDIUM | DONE (device pending) |
| 003 | [Success feedback wiring (haptics + toasts)](003-success-feedback-wiring.md) | MEDIUM | DONE (device pending) |
