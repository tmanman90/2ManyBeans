...
test('natural model questions are declared while photo-first proposal permission stays a failure', async () => {
  ...
  const observed = [
    ...
    ['AE14', 1, 'Got it—the hot V60 is the right setup. Did the cup feel hollow and underpowered, or mainly dull and lacking aroma?', 'It was mainly bland with little sweetness.'],
